...
export default function TableTicketMandiri() {
  ...
  const ticketsPerPage = 5; // jumlah row per page
    ...
    const fetchTickets = async () => {
      try {
        ...
        const response = await fetch(
          `${env.api.url}/ticket/mandiri/open`,
          {
            headers: {
    ...
    return (
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white p-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          Ticket Opened - Customer Mandiri
        </h3>
      ...
      <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex gap-3">
          ...
          <select
            ...
            className="px-3 py-1 mr-5 border rounded-md text-sm dark:bg-gray-700 dark:text-white"
          >
          ...
          {/* <img
            src="../../images/logo/Bank_Mandiri_logo_2016.png"
            alt="Mandiri Logo"
